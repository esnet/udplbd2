...
pub enum ServerDebugFlag {
    ...
    DebugFlagPipelineInfo = 10,
    DebugFlagPipelineDriver = 11,
    DebugFlagStats = 20,
}
impl ServerDebugFlag {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::DebugFlagPipelineInfo => "DEBUG_FLAG_PIPELINE_INFO",
            Self::DebugFlagPipelineDriver => "DEBUG_FLAG_PIPELINE_DRIVER",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "DEBUG_FLAG_PIPELINE_INFO" => Some(Self::DebugFlagPipelineInfo),
            "DEBUG_FLAG_PIPELINE_DRIVER" => Some(Self::DebugFlagPipelineDriver),
