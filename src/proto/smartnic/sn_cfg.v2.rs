...
pub struct StringRegexp {
    /// When unset, defaults to ECMAScript.
    #[prost(enumeration = "StringRegexpGrammar", tag = "1")]
    pub grammar: i32,
    #[prost(string, tag = "2")]
...
pub struct StatsMetricValue {
    ...
    #[prost(uint32, tag = "3")]
    pub index: u32,
    /// Populated when the "with_labels" flag in StatsFilters
    #[prost(message, repeated, tag = "4")]
    pub labels: ::prost::alloc::vec::Vec<StatsMetricLabel>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StatsMetric {
    ...
    pub last_update: ::core::option::Option<::prost_wkt_types::Timestamp>,
...
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StatsMetricMatchString {
    /// Acts as a wildcard when unset.
    #[prost(oneof = "stats_metric_match_string::Method", tags = "1, 2, 3, 4, 5, 6")]
    pub method: ::core::option::Option<stats_metric_match_string::Method>,
}
/// Nested message and enum types in `StatsMetricMatchString`.
pub mod stats_metric_match_string {
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Split {
        /// Regular expression pattern to use for splitting the string into parts
        #[prost(string, tag = "1")]
        pub pattern: ::prost::alloc::string::String,
        /// true: Split is true when ANY of the parts match (logical OR over parts).
        #[prost(bool, tag = "2")]
        pub any: bool,
        /// Specifies how to match each part after
        #[prost(message, optional, boxed, tag = "3")]
        pub part: ::core::option::Option<::prost::alloc::boxed::Box<split::Part>>,
    }
    ...
    pub mod split {
        ...
        #[derive(Clone, PartialEq, ::prost::Message)]
        pub struct Part {
            /// Logical negation of the final result after computing the term.
            #[prost(bool, tag = "1")]
            pub negated: bool,
            /// Acts as a wildcard when unset.
            #[prost(oneof = "part::Term", tags = "10, 11, 12")]
            pub term: ::core::option::Option<part::Term>,
        }
        ...
        pub mod part {
            ...
            pub struct Match {
                /// Acts as a wildcard when unset.
                #[prost(oneof = "r#match::Attribute", tags = "1, 2")]
                pub attribute: ::core::option::Option<r#match::Attribute>,
            }
            ...
            pub mod r#match {
                ...
                pub enum Attribute {
                    /// Singular string match to apply.
                    #[prost(message, tag = "1")]
                    Value(
                        ::prost::alloc::boxed::Box<
                            super::super::super::super::StatsMetricMatchString,
                        >,
                    ),
                    /// Used to match against a single part of the split (used for
                    #[prost(uint32, tag = "2")]
                    Index(u32),
                }
            }
            ...
            pub struct Set {
                ...
                pub members: ::prost::alloc::vec::Vec<super::Part>,
            }
            /// Acts as a wildcard when unset.
            #[derive(serde::Serialize, serde::Deserialize)]
            #[derive(Clone, PartialEq, ::prost::Oneof)]
            pub enum Term {
                /// Singular match to apply.
                #[prost(message, tag = "10")]
                Match(::prost::alloc::boxed::Box<Match>),
                /// Logical OR of matches.
                #[prost(message, tag = "11")]
                AnySet(Set),
                /// Logical AND of matches.
    ...
    pub enum Method {
        ...
        #[prost(message, tag = "5")]
        Regexp(super::StringRegexp),
        /// Split the string and match each part.
        #[prost(message, tag = "6")]
        Split(::prost::alloc::boxed::Box<Split>),
    }
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct StatsMetricMatchIndexSlice {
    /// Index of the first value included in the slice. Use a negative value to
    #[prost(sint32, tag = "1")]
    pub start: i32,
    /// indicate the index is relative to the end of the range. Must be \<= to the
    /// end index.
    ///
    /// Index of the last value included in the slice. Use a negative value to
    #[prost(sint32, tag = "2")]
    pub end: i32,
    /// indicate the index is relative to the end of the range. Must be >= to the
    /// start index.
    ///
    /// Increment applied from the start index until, and not exceeding, the end.
    #[prost(uint32, tag = "3")]
    pub step: u32,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StatsMetricMatchIndices {
    ...
    #[prost(message, repeated, tag = "1")]
    pub slices: ::prost::alloc::vec::Vec<StatsMetricMatchIndexSlice>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StatsMetricMatchLabel {
    /// The result of the key and value matches are logically ANDed.
    ///
    /// Leave unset to wildard.
    #[prost(message, optional, tag = "1")]
    pub key: ::core::option::Option<StatsMetricMatchString>,
    /// Leave unset to wildcard.
    #[prost(message, optional, tag = "2")]
    pub value: ::core::option::Option<StatsMetricMatchString>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StatsMetricMatch {
    /// Acts as a wildcard when unset.
    #[prost(oneof = "stats_metric_match::Attribute", tags = "1, 2, 3, 4, 5, 6, 7")]
    pub attribute: ::core::option::Option<stats_metric_match::Attribute>,
}
/// Nested message and enum types in `StatsMetricMatch`.
pub mod stats_metric_match {
    /// Acts as a wildcard when unset.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Attribute {
        /// Restrict to metrics of this type.
        #[prost(enumeration = "super::StatsMetricType", tag = "1")]
        Type(i32),
        /// Restrict the domain containing a metric.
        #[prost(message, tag = "2")]
        Domain(super::StatsMetricMatchString),
        /// Restrict the zone containing a metric.
        #[prost(message, tag = "3")]
        Zone(super::StatsMetricMatchString),
        /// Restrict of the block containing a metric.
        #[prost(message, tag = "4")]
        Block(super::StatsMetricMatchString),
        /// Restrict the name of the metric.
        #[prost(message, tag = "5")]
        Name(super::StatsMetricMatchString),
        /// Restrict the range of indices deemed valid.
        #[prost(message, tag = "6")]
        Indices(super::StatsMetricMatchIndices),
        /// Restrict which labels are possessed by a metric.
        #[prost(message, tag = "7")]
        Label(super::StatsMetricMatchLabel),
    }
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct StatsMetricFilter {
    /// Logical negation of the final result after computing the term.
    #[prost(bool, tag = "1")]
    pub negated: bool,
    /// Acts as a wildcard when unset.
    #[prost(oneof = "stats_metric_filter::Term", tags = "10, 11, 12")]
    pub term: ::core::option::Option<stats_metric_filter::Term>,
}
/// Nested message and enum types in `StatsMetricFilter`.
pub mod stats_metric_filter {
    ...
    pub struct Set {
        #[prost(message, repeated, tag = "1")]
        pub members: ::prost::alloc::vec::Vec<super::StatsMetricFilter>,
    }
    /// Acts as a wildcard when unset.
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Term {
        /// Match a singular metric attribute.
        #[prost(message, tag = "10")]
        Match(super::StatsMetricMatch),
...
pub struct StatsFilters {
    ...
    #[deprecated]
    #[prost(enumeration = "StatsMetricType", repeated, packed = "false", tag = "1")]
    pub metric_types: ::prost::alloc::vec::Vec<i32>,
    /// Restrict metrics to those whose value is not zero. This check is applied
    #[prost(bool, tag = "2")]
    pub non_zero: bool,
    /// Logical expression used to restrict metrics by matching
    #[prost(message, optional, tag = "3")]
    pub metric_filter: ::core::option::Option<StatsMetricFilter>,
    /// Include the labels associated with each metric value.
    #[prost(bool, tag = "4")]
...
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct DeviceBuildEnvironment {
    #[prost(string, tag = "1")]
...
pub struct DeviceBuildInfo {
    ...
    #[prost(message, optional, tag = "4")]
    pub env: ::core::option::Option<DeviceBuildEnvironment>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub struct HostFunctionId {
    #[prost(enumeration = "HostFunctionType", tag = "1")]
    pub ftype: i32,
    #[prost(uint32, tag = "2")]
    pub index: u32,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct HostFunctionDmaConfig {
    #[prost(message, optional, tag = "1")]
    pub func_id: ::core::option::Option<HostFunctionId>,
    #[prost(uint32, tag = "2")]
    pub base_queue: u32,
    #[prost(uint32, tag = "3")]
    pub num_queues: u32,
...
pub struct HostDmaConfig {
    #[prost(message, repeated, tag = "1")]
    pub functions: ::prost::alloc::vec::Vec<HostFunctionDmaConfig>,
    /// Reset all function DMA configuration prior to applying new settings (if any).
    #[prost(bool, tag = "2")]
    pub reset: bool,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct HostFlowControl {
    /// FIFO fill level threshold at which to assert egress flow control.
    #[prost(sint32, tag = "1")]
    pub egress_threshold: i32,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct HostConfig {
    ...
    #[prost(message, optional, tag = "2")]
    pub flow_control: ::core::option::Option<HostFlowControl>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct PortConfig {
    ...
    pub loopback: i32,
    #[prost(message, optional, tag = "4")]
    pub flow_control: ::core::option::Option<PortFlowControl>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SwitchIngressSelector {
    /// 0-based port index.
    #[prost(uint32, tag = "1")]
    pub index: u32,
    #[prost(enumeration = "SwitchInterface", tag = "2")]
    pub intf: i32,
    #[prost(enumeration = "SwitchDestination", tag = "3")]
    pub dest: i32,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SwitchEgressSelector {
    /// 0-based port index.
    #[prost(uint32, tag = "1")]
    pub index: u32,
    #[prost(enumeration = "SwitchInterface", tag = "2")]
...
pub struct SwitchConfig {
    ...
    #[prost(message, repeated, tag = "1")]
    pub ingress_selectors: ::prost::alloc::vec::Vec<SwitchIngressSelector>,
    /// Array containing one selector per egress port.
    #[prost(message, repeated, tag = "2")]
    pub egress_selectors: ::prost::alloc::vec::Vec<SwitchEgressSelector>,
    #[prost(enumeration = "SwitchBypassMode", tag = "3")]
    pub bypass_mode: i32,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct ServerStatus {
    ...
    #[prost(message, optional, tag = "2")]
    pub up_time: ::core::option::Option<::prost_wkt_types::Duration>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
...
pub enum ErrorCode {
    ...
    EcUnsupportedHostId = 302,
    EcUnsupportedHostFunction = 303,
    EcFailedGetHostFunctionDmaQueues = 304,
    EcFailedSetHostFunctionDmaQueues = 305,
    EcFailedGetHostFcEgrThreshold = 306,
    EcFailedSetHostFcEgrThreshold = 307,
    ...
    EcFailedGetPortFcEgrThreshold = 406,
    EcFailedSetPortFcEgrThreshold = 407,
    /// Switch configuration error codes.
    EcMissingSwitchConfig = 500,
    EcUnsupportedIgrSelIntf = 501,
    EcUnsupportedIgrSelDest = 502,
    EcFailedGetIgrSel = 503,
    EcFailedSetIgrSel = 504,
    EcUnsupportedEgrSelIntf = 505,
    EcFailedGetEgrSel = 506,
    EcFailedSetEgrSel = 507,
    EcUnsupportedBypassMode = 508,
    EcFailedGetBypassMode = 509,
    EcFailedSetBypassMode = 510,
...
impl ErrorCode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::EcUnsupportedHostFunction => "EC_UNSUPPORTED_HOST_FUNCTION",
            Self::EcFailedGetHostFunctionDmaQueues => {
                "EC_FAILED_GET_HOST_FUNCTION_DMA_QUEUES"
            }
            Self::EcFailedSetHostFunctionDmaQueues => {
                "EC_FAILED_SET_HOST_FUNCTION_DMA_QUEUES"
            }
            Self::EcFailedGetHostFcEgrThreshold => "EC_FAILED_GET_HOST_FC_EGR_THRESHOLD",
            Self::EcFailedSetHostFcEgrThreshold => "EC_FAILED_SET_HOST_FC_EGR_THRESHOLD",
            ...
            Self::EcFailedGetPortFcEgrThreshold => "EC_FAILED_GET_PORT_FC_EGR_THRESHOLD",
            Self::EcFailedSetPortFcEgrThreshold => "EC_FAILED_SET_PORT_FC_EGR_THRESHOLD",
            Self::EcMissingSwitchConfig => "EC_MISSING_SWITCH_CONFIG",
            Self::EcUnsupportedIgrSelIntf => "EC_UNSUPPORTED_IGR_SEL_INTF",
            Self::EcUnsupportedIgrSelDest => "EC_UNSUPPORTED_IGR_SEL_DEST",
            Self::EcFailedGetIgrSel => "EC_FAILED_GET_IGR_SEL",
            Self::EcFailedSetIgrSel => "EC_FAILED_SET_IGR_SEL",
            Self::EcUnsupportedEgrSelIntf => "EC_UNSUPPORTED_EGR_SEL_INTF",
            Self::EcFailedGetEgrSel => "EC_FAILED_GET_EGR_SEL",
            Self::EcFailedSetEgrSel => "EC_FAILED_SET_EGR_SEL",
            Self::EcUnsupportedBypassMode => "EC_UNSUPPORTED_BYPASS_MODE",
            Self::EcFailedGetBypassMode => "EC_FAILED_GET_BYPASS_MODE",
            Self::EcFailedSetBypassMode => "EC_FAILED_SET_BYPASS_MODE",
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "EC_UNSUPPORTED_HOST_FUNCTION" => Some(Self::EcUnsupportedHostFunction),
            "EC_FAILED_GET_HOST_FUNCTION_DMA_QUEUES" => {
                Some(Self::EcFailedGetHostFunctionDmaQueues)
            }
            "EC_FAILED_SET_HOST_FUNCTION_DMA_QUEUES" => {
                Some(Self::EcFailedSetHostFunctionDmaQueues)
            }
            "EC_FAILED_GET_HOST_FC_EGR_THRESHOLD" => {
                Some(Self::EcFailedGetHostFcEgrThreshold)
            }
            "EC_FAILED_SET_HOST_FC_EGR_THRESHOLD" => {
                Some(Self::EcFailedSetHostFcEgrThreshold)
            }
            ...
            "EC_FAILED_GET_PORT_FC_EGR_THRESHOLD" => {
                Some(Self::EcFailedGetPortFcEgrThreshold)
            }
            "EC_FAILED_SET_PORT_FC_EGR_THRESHOLD" => {
                Some(Self::EcFailedSetPortFcEgrThreshold)
            }
            "EC_MISSING_SWITCH_CONFIG" => Some(Self::EcMissingSwitchConfig),
            "EC_UNSUPPORTED_IGR_SEL_INTF" => Some(Self::EcUnsupportedIgrSelIntf),
            "EC_UNSUPPORTED_IGR_SEL_DEST" => Some(Self::EcUnsupportedIgrSelDest),
            "EC_FAILED_GET_IGR_SEL" => Some(Self::EcFailedGetIgrSel),
            "EC_FAILED_SET_IGR_SEL" => Some(Self::EcFailedSetIgrSel),
            "EC_UNSUPPORTED_EGR_SEL_INTF" => Some(Self::EcUnsupportedEgrSelIntf),
            "EC_FAILED_GET_EGR_SEL" => Some(Self::EcFailedGetEgrSel),
            "EC_FAILED_SET_EGR_SEL" => Some(Self::EcFailedSetEgrSel),
            "EC_UNSUPPORTED_BYPASS_MODE" => Some(Self::EcUnsupportedBypassMode),
            "EC_FAILED_GET_BYPASS_MODE" => Some(Self::EcFailedGetBypassMode),
            "EC_FAILED_SET_BYPASS_MODE" => Some(Self::EcFailedSetBypassMode),
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum StringRegexpGrammar {
    /// Field is unset.
    StrRegexpGrammarUnknown = 0,
    /// <https://en.cppreference.com/w/cpp/regex/ecmascript>
    StrRegexpGrammarEcmaScript = 1,
    /// <https://eel.is/c++draft/re.grammar>
    StrRegexpGrammarBasicPosix = 2,
    StrRegexpGrammarExtendedPosix = 3,
    StrRegexpGrammarAwk = 4,
    StrRegexpGrammarGrep = 5,
    StrRegexpGrammarEgrep = 6,
}
impl StringRegexpGrammar {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::StrRegexpGrammarUnknown => "STR_REGEXP_GRAMMAR_UNKNOWN",
            Self::StrRegexpGrammarEcmaScript => "STR_REGEXP_GRAMMAR_ECMA_SCRIPT",
            Self::StrRegexpGrammarBasicPosix => "STR_REGEXP_GRAMMAR_BASIC_POSIX",
            Self::StrRegexpGrammarExtendedPosix => "STR_REGEXP_GRAMMAR_EXTENDED_POSIX",
            Self::StrRegexpGrammarAwk => "STR_REGEXP_GRAMMAR_AWK",
            Self::StrRegexpGrammarGrep => "STR_REGEXP_GRAMMAR_GREP",
            Self::StrRegexpGrammarEgrep => "STR_REGEXP_GRAMMAR_EGREP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "STR_REGEXP_GRAMMAR_UNKNOWN" => Some(Self::StrRegexpGrammarUnknown),
            "STR_REGEXP_GRAMMAR_ECMA_SCRIPT" => Some(Self::StrRegexpGrammarEcmaScript),
            "STR_REGEXP_GRAMMAR_BASIC_POSIX" => Some(Self::StrRegexpGrammarBasicPosix),
            "STR_REGEXP_GRAMMAR_EXTENDED_POSIX" => {
                Some(Self::StrRegexpGrammarExtendedPosix)
            }
            "STR_REGEXP_GRAMMAR_AWK" => Some(Self::StrRegexpGrammarAwk),
            "STR_REGEXP_GRAMMAR_GREP" => Some(Self::StrRegexpGrammarGrep),
            "STR_REGEXP_GRAMMAR_EGREP" => Some(Self::StrRegexpGrammarEgrep),
            _ => None,
        }
    }
}
...
impl HostFunctionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::HostFuncUnknown => "HOST_FUNC_UNKNOWN",
            Self::HostFuncPhysical => "HOST_FUNC_PHYSICAL",
            Self::HostFuncVirtual => "HOST_FUNC_VIRTUAL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "HOST_FUNC_UNKNOWN" => Some(Self::HostFuncUnknown),
            "HOST_FUNC_PHYSICAL" => Some(Self::HostFuncPhysical),
            "HOST_FUNC_VIRTUAL" => Some(Self::HostFuncVirtual),
            _ => None,
        }
    }
}
...
impl SwitchInterface {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::SwIntfPhysical => "SW_INTF_PHYSICAL",
            Self::SwIntfTest => "SW_INTF_TEST",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "SW_INTF_PHYSICAL" => Some(Self::SwIntfPhysical),
            "SW_INTF_TEST" => Some(Self::SwIntfTest),
            _ => None,
        }
    }
}
...
impl SwitchDestination {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::SwDestUnknown => "SW_DEST_UNKNOWN",
            Self::SwDestBypass => "SW_DEST_BYPASS",
            Self::SwDestDrop => "SW_DEST_DROP",
            Self::SwDestApp => "SW_DEST_APP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "SW_DEST_UNKNOWN" => Some(Self::SwDestUnknown),
            "SW_DEST_BYPASS" => Some(Self::SwDestBypass),
            "SW_DEST_DROP" => Some(Self::SwDestDrop),
            "SW_DEST_APP" => Some(Self::SwDestApp),
            _ => None,
        }
    }
}
...
#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash, PartialOrd, Ord, ::prost::Enumeration)]
#[repr(i32)]
pub enum SwitchBypassMode {
    /// Field is unset.
    SwBypassUnknown = 0,
    SwBypassStraight = 1,
    SwBypassSwap = 2,
}
impl SwitchBypassMode {
    /// String value of the enum field names used in the ProtoBuf definition.
    ///
    /// The values are not transformed in any way and thus are considered stable
    /// (if the ProtoBuf definition does not change) and safe for programmatic use.
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::SwBypassUnknown => "SW_BYPASS_UNKNOWN",
            Self::SwBypassStraight => "SW_BYPASS_STRAIGHT",
            Self::SwBypassSwap => "SW_BYPASS_SWAP",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "SW_BYPASS_UNKNOWN" => Some(Self::SwBypassUnknown),
            "SW_BYPASS_STRAIGHT" => Some(Self::SwBypassStraight),
            "SW_BYPASS_SWAP" => Some(Self::SwBypassSwap),
            _ => None,
        }
    }
}
...
impl ServerDebugFlag {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::DebugFlagStats => "DEBUG_FLAG_STATS",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "DEBUG_FLAG_STATS" => Some(Self::DebugFlagStats),
            _ => None,
        }
    }
}
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/Batch",
            );
            let mut req = request.into_streaming_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "Batch"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/SetDefaults",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "SetDefaults"));
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetDeviceInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetDeviceInfo"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetDeviceStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetDeviceStatus"));
            self.inner.server_streaming(req, path, codec).await
        }
        /// Host configuration.
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetHostConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetHostConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/SetHostConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "SetHostConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetHostStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetHostStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/ClearHostStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "ClearHostStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        /// Module configuration.
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetModuleGpio",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetModuleGpio"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/SetModuleGpio",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "SetModuleGpio"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetModuleInfo",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetModuleInfo"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetModuleMem",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetModuleMem"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/SetModuleMem",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "SetModuleMem"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetModuleStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetModuleStatus"));
            self.inner.server_streaming(req, path, codec).await
        }
        /// Port configuration.
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetPortConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetPortConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/SetPortConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "SetPortConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetPortStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetPortStatus"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetPortStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetPortStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/ClearPortStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "ClearPortStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        /// Statistics configuration.
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/ClearStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "ClearStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        /// Switch configuration.
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetSwitchConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetSwitchConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/SetSwitchConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "SetSwitchConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetSwitchStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetSwitchStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/ClearSwitchStats",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "ClearSwitchStats"));
            self.inner.server_streaming(req, path, codec).await
        }
        /// Server configuration.
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetServerConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetServerConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/SetServerConfig",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "SetServerConfig"));
            self.inner.server_streaming(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/sn_cfg.v2.SmartnicConfig/GetServerStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("sn_cfg.v2.SmartnicConfig", "GetServerStatus"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
...
pub mod smartnic_config_server {
    ...
    pub const SERVICE_NAME: &str = "sn_cfg.v2.SmartnicConfig";
