...
pub struct SlotRange {
    /// first slot in the range, or -1 to find first empty
    #[prost(int32, tag = "1")]
    pub index: i32,
    /// length of the range in number of slots
    #[prost(uint32, tag = "2")]
    pub length: u32,
}
#[derive(serde::Serialize, serde::Deserialize)]
...
pub struct SessionSlotRanges {
    ...
    /// If any slot ranges are provided this way or via UpdateSlots, slot shuffling will be turned off
    /// and load balancing performance is likely to be slightly worse. Only use if you are using the
    /// slot selector with something other than randomness
    #[prost(message, repeated, tag = "2")]
    pub slots: ::prost::alloc::vec::Vec<SlotRange>,
}
/// ReserveLoadBalancer
#[derive(serde::Serialize, serde::Deserialize)]
...
pub struct ReserveLoadBalancerRequest {
    ...
    /// 'dynamic' (or empty string/default) - balance undemanded slots according to control signals
    /// 'static' - assign slots according to weight and slotDemands at registration, only rebalance
    /// on registration/slotDemand updates
    /// 'explicit' - only apply slot demands, slots not explicitly assigned this way will drop packets
    #[prost(string, tag = "10")]
...
pub struct WorkerStatus {
    ...
    /// the slots that were assigned in the latest epoch
...
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SetSlotDemandsRequest {
    #[prost(string, tag = "1")]
    pub lb_id: ::prost::alloc::string::String,
    #[prost(message, repeated, tag = "2")]
    pub slot_constraints: ::prost::alloc::vec::Vec<SessionSlotRanges>,
}
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SetSlotDemandsReply {}
/// Deregister
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
pub mod load_balancer_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn set_slot_demands(
            &mut self,
            request: impl tonic::IntoRequest<super::SetSlotDemandsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SetSlotDemandsReply>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("loadbalancer.LoadBalancer", "SetSlotDemands"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod load_balancer_server {
    ...
    pub trait LoadBalancer: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn set_slot_demands(
            &self,
            request: tonic::Request<super::SetSlotDemandsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SetSlotDemandsReply>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/loadbalancer.LoadBalancer/SetSlotDemands" => {
                    #[allow(non_camel_case_types)]
                    struct SetSlotDemandsSvc<T: LoadBalancer>(pub Arc<T>);
                    impl<
                        T: LoadBalancer,
                    > tonic::server::UnaryService<super::SetSlotDemandsRequest>
                    for SetSlotDemandsSvc<T> {
                        type Response = super::SetSlotDemandsReply;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as LoadBalancer>::set_slot_demands(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetSlotDemandsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
